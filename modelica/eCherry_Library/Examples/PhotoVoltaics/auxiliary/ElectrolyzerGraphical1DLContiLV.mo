...
model ElectrolyzerGraphical1DLContiLV
  "Used to plot the U-I curve of the electrolysis cell."
 ...
 parameter Length Z=0.1;
  ...
  ElectrochemicalReactor.ElectricalDomain.Source.Potential_Source.Voltage_LinearSweepVoltammetry
    ...
    tAux=1,
    Uaux=-2.5,
    Ubase=0) annotation (Placement(transformation(extent={{-26,32},{-46,52}})));
equation
  ...
  connect(linearSweepVoltammetry.p, Cathode.n) annotation (Line(points={{-26,42},
          {142,42},{142,-86},{136,-86}}, color={0,0,255}));
  connect(linearSweepVoltammetry.n, Anode.p) annotation (Line(points={{-46,42},
          {-252,42},{-252,-80},{-246,-80}}, color={0,0,255}));
  connect(linearSweepVoltammetry.p, Ground.p) annotation (Line(points={{-26,42},
          {76,42},{76,80},{60,80},{60,74}}, color={0,0,255}));
  annotation (experiment(
      __Dymola_NumberOfIntervals=20000,
      Tolerance=1e-12,
      __Dymola_Algorithm="Dassl"));
end ElectrolyzerGraphical1DLContiLV;
