...
model Electrolyzer_Conti_1D_L_PV_flex
 ...
 parameter String fileNameIrradiance = Modelica.Utilities.Files.loadResource("modelica://eCherry_Library/externalData/V20A.txt") "Irradiance data file name";
  ...
  Modelica.Blocks.Sources.CombiTimeTable irradianceTable(
    ...
    Placement(transformation(extent={{-174,84},{-154,104}})));
equation
  ...
  connect(cell3.variableIrradiance, cell.variableIrradiance) annotation (Line(
        points={{-30,42},{-30,76},{-110,76},{-110,42}}, color={0,0,127}));
  ...
  connect(irradianceTable.y[1], cell1.variableIrradiance)
    annotation (Line(points={{-153,94},{-90,94},{-90,42}}, color={0,0,127}));
  connect(cell.variableIrradiance, irradianceTable.y[1])
    annotation (Line(points={{-110,42},{-110,94},{-153,94}}, color={0,0,127}));
  annotation (experiment(
      StopTime=20,
      __Dymola_NumberOfIntervals=20000,
      Tolerance=1e-12,
      __Dymola_Algorithm="Dassl"));
end Electrolyzer_Conti_1D_L_PV_flex;
