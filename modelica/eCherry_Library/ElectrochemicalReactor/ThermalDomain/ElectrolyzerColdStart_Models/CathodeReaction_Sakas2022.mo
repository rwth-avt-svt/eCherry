...
model CathodeReaction_Sakas2022
 ...
 //redeclare model actmodel;
  ...
  input Pressure P;
  inner String electrode= "cathode";

  // Models
  eCherry_Library.ElectrochemicalReactor.ThermalDomain.ElectrolyzerColdStart_Models.EquilibriumPotential_Sakas2022
    eqP(
    specRec=specRec,
    reac=reac,
    T=T,
