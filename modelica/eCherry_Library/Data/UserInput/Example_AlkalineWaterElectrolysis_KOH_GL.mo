...
record Example_AlkalineWaterElectrolysis_KOH_GL
  ...
  //Concentrations: Define the initial concentrations within your bulk electrolyte
    ...
    constant Modelica.Units.SI.Pressure Pi[GSpec.nSpec]={100000,100000};
    constant Modelica.Units.SI.AmountOfSubstance mol_vec_0[AWEKOHspec.nSpec]={0,1.45e-12,1e-4,6000,6000,55e3}/100;
    constant Modelica.Units.SI.AmountOfSubstance mol_tot_0=619;
    constant Modelica.Units.SI.MolarFlowRate molFlow_vec[AWEKOHspec.nSpec]={0,1.45e-12,1e-4,6000, 6000, 55e3};

end Example_AlkalineWaterElectrolysis_KOH_GL;
