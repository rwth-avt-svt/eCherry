...
record Reaction "Storing relevant data for electrochemical Reaction"
 parameter String[:] species;
 parameter Real[:] nu;
 parameter Real [:] RO={0,0};                                         //default value since not always used
 parameter Integer z "number of electrons transferred (positive)";
 ...
 parameter ElectrochemicalReactor.Electrodes.Electrochemistry.Eeq0.Eeq0Tmodel
